...
const Skills = ({ darkMode }) => {
    const skills = [
         ...
         {name: "JavaScript", icon: js, level: 88,
            ...
            {name: "Wordpress", icon: wordpress, level: 98,
             color: 'from-violate-500 to-blue-500'},
             {name: "React", icon: react, level: 50,
                color: 'from-green-500 to-lime-400'},
                {name: "Nodejs", icon:nodejs, level:50,
                    color: 'from-pink-500 to-purple-500'},
            {name: "Mongodb", icon: mongodb, level:70,
                color: 'from-black-500 to-green-500'},
            ...
            <div className="container px-5 py-14 mx-auto">
                ...
                data-aos='fade-up'>
                    ...
                    >
                       ...
                       I have experience working with modern web technologies and tools to create fast,
