        ...
        items-center gap-6">
            <div className="text-center md:text-left">
                ...
                style={{
                    ...
                    MERN Full Stack Developer & Wordpress Developer

                </p>

            </div>
              <div className="flex gap-4">
                <a href="https://github.com/farzana2005"
                ...
                text-white  dark:text-[#374151]">
                  ...
                  <a href="https://www.instagram.com/farzana_arefin_poly/"
                className=" w-10 h-10 rounded-full flex items-center
                justify-center hover:scale-110 transition-all
                hover:bg-linear-to-r hover:from-orange-500
                hover:to-amber-500 hover:text-white
                ...
                text-white  dark:text-[#374151]">
                  ...
                  <a href="https://www.facebook.com/farzana.arefin.poly"
                className=" w-10 h-10 rounded-full flex items-center
                justify-center hover:scale-110 transition-all
                hover:bg-linear-to-r hover:from-orange-500
                hover:to-amber-500 hover:text-white
